...
var maxNoChartsBlocked=6,currentNoChartsBlocked=0,maxNoChartsTotal=6,currentNoChartsTotal=0,maxNoChartsTotalBlocked=3,currentNoChartsTotalBlocked=0,maxNoChartsOverall=15,currentNoChartsOverall=0,arrayqueryloglines=[],originalarrayqueryloglines=[],sortname="Time",sortdir="desc",tout,ramAvailableSpace="0 Bytes",sqlDatabaseFileSize="0 Bytes",tmpfsAvailableSpace="0 Bytes",backgroundProcsState="ENABLED";const InvREDct='<span style="margin-left:2px; background-color:#C81927; color:#f2f2f2;">&nbsp;',InvGRNct='<span style="margin-left:2px; background-color:#229652; color:#f2f2f2;">&nbsp;',InvYLWct='<span style="margin-left:2px; background-color:yellow; color:black;">&nbsp;',InvCLEAR="&nbsp;</span>";function keyHandler(t){82==t.keyCode?($(document).off("keydown"),ResetZoom()):70==t.keyCode&&($(document).off("keydown"),ToggleFill())}function isFilterIP(t,e){var a,i=e.keyCode?e.keyCode:e.which;if(validator.isFunctionButton(e))return!0;if(33==i)return!0;if(i>47&&i<58){a=0;for(var o=0;o<t.value.length;o++)"."==t.value.charAt(o)&&a++;return a<3&&o>=3&&"."!=t.value.charAt(o-3)&&"."!=t.value.charAt(o-2)&&"."!=t.value.charAt(o-1)&&(t.value=t.value+"."),!0}if(46==i){a=0;for(o=0;o<t.value.length;o++)"."==t.value.charAt(o)&&a++;return"."!=t.value.charAt(o-1)&&3!=a}return 13==i||!(!e.metaKey||65!=i&&67!=i&&86!=i&&88!=i&&97!=i&&99!=i&&118!=i&&120!=i)}function ValidateNumberSetting(t,e,a){t.name;var i=1*t.value;return i>e||i<a?($(t).addClass("invalid"),!1):($(t).removeClass("invalid"),!0)}function FormatNumberSetting(t){t.name;var e=1*t.value;return 0!=t.value.length&&NaN!=e&&(t.value=parseInt(t.value),!0)}Chart.defaults.global.defaultFontColor="#CCC",Chart.Tooltip.positioners.cursor=function(t,e){return e};const theDaysToKeepMIN=15,theDaysToKeepDEF=30,theDaysToKeepMAX=365,theDaysToKeepTXT=`(between ${theDaysToKeepMIN} and ${theDaysToKeepMAX}, default: ${theDaysToKeepDEF})`,theLastXQueriesMIN=10,theLastXQueriesDEF=5e3,theLastXQueriesMAX=1e4,theLastXQueriesTXT=`(between ${theLastXQueriesMIN} and ${theLastXQueriesMAX}, default: ${theLastXQueriesDEF})`;function ValidateAll(){var t=!1;return ValidateNumberSetting(document.form.uidivstats_lastxqueries,theLastXQueriesMAX,theLastXQueriesMIN)||(t=!0),ValidateNumberSetting(document.form.uidivstats_daystokeep,theDaysToKeepMAX,theDaysToKeepMIN)||(t=!0),!t||(alert("**ERROR**\nValidation for some fields failed.\nPlease correct invalid values and try again."),!1)}$(document).keydown((function(t){keyHandler(t)})),$(document).keyup((function(t){$(document).keydown((function(t){keyHandler(t)}))}));var metriclist=["Blocked","Total"],chartlist=["daily","weekly","monthly"],timeunitlist=["hour","day","day"],intervallist=[24,7,30],bordercolourlist=["#fc8500","#42ecf5"],backgroundcolourlist=["rgba(252,133,0,0.5)","rgba(66,236,245,0.5)"],myinterval;function Draw_Chart_NoData(t,e){document.getElementById("canvasChart"+t).width="735",document.getElementById("canvasChart"+t).height="500",document.getElementById("canvasChart"+t).style.width="735px",document.getElementById("canvasChart"+t).style.height="500px";var a=document.getElementById("canvasChart"+t).getContext("2d");a.save(),a.textAlign="center",a.textBaseline="middle",a.font="normal normal bolder 48px Arial",a.fillStyle="white",a.fillText(e,368,250),a.restore()}function Draw_Chart(t){var e,a=getChartPeriod($("#"+t+"_Period option:selected").val()),i=getChartType($("#"+t+"_Type option:selected").val()),o=$("#"+t+"_Clients option:selected").text(),n=o.substring(o.indexOf("(")+1,o.indexOf(")",o.indexOf("(")+1));if(null!=(e="All (*)"==o?window[t+a]:window[t+a+"clients"])&&0!==e.length){var r,l,s=[];"All (*)"==o?(r=e.map((function(t){return t.Count})),l=e.map((function(t){return t.ReqDmn}))):(r=e.filter((function(t){return t.SrcIP==n})).map((function(t){return t.Count})),l=e.filter((function(t){return t.SrcIP==n})).map((function(t){return t.ReqDmn})));for(var d=0;d<l.length;d++)l[d].length<=33?s.push(l[d]):s.push(l[d].substr(0,25)+"...");$.each(s,(function(t,e){s[t]=ChunkString(e.toLowerCase(),50).join("\n")})),$.each(l,(function(t,e){l[t]=ChunkString(e.toLowerCase(),50).join("\n")}));var c=window["Chart"+t];void 0!==c&&c.destroy();var u=document.getElementById("canvasChart"+t).getContext("2d"),h={segmentShowStroke:!1,segmentStrokeColor:"#000",animationEasing:"easeOutQuart",animationSteps:100,maintainAspectRatio:!1,animateScale:!0,legend:{onClick:null,display:showLegend(i),position:"left",labels:{fontColor:"#ffffff"}},layout:{padding:{top:getChartPadding(i)}},title:{display:showTitle(i),text:getChartLegendTitle(),position:"top"},tooltips:{callbacks:{title:function(t,e){return e.labelsLong[t[0].index]},label:function(t,e){return e.datasets[t.datasetIndex].data[t.index]}},mode:"point",position:"cursor",intersect:!0},scales:{xAxes:[{display:showAxis(i,"x"),type:getChartScale($("#"+t+"_Scale option:selected").val(),i,"x"),gridLines:{display:showGrid(i,"x"),color:"#282828"},scaleLabel:{display:!0,labelString:getAxisLabel(i,"x")},ticks:{display:showTicks(i,"x"),beginAtZero:!0,labels:{index:["min","max"],removeEmptyLines:!0},userCallback:LogarithmicFormatter}}],yAxes:[{display:showAxis(i,"y"),type:getChartScale($("#"+t+"_Scale option:selected").val(),i,"y"),gridLines:{display:!1,color:"#282828"},scaleLabel:{display:!0,labelString:getAxisLabel(i,"y")},ticks:{display:showTicks(i,"y"),beginAtZero:!0,autoSkip:!1,lineHeight:.8,padding:-5,labels:{index:["min","max"],removeEmptyLines:!0},userCallback:LogarithmicFormatter}}]},plugins:{zoom:{pan:{enabled:!1,mode:ZoomPanEnabled(i),rangeMin:{x:0,y:0},rangeMax:{x:ZoomPanMax(i,"x",r),y:ZoomPanMax(i,"y",r)}},zoom:{enabled:!0,drag:!0,mode:ZoomPanEnabled(i),rangeMin:{x:0,y:0},rangeMax:{x:ZoomPanMax(i,"x",r),y:ZoomPanMax(i,"y",r)},speed:.1}}}},m={labels:s,labelsLong:l,datasets:[{data:r,borderWidth:1,backgroundColor:poolColors(l.length),borderColor:"#000000"}]};c=new Chart(u,{type:i,options:h,data:m,plugins:[{beforeInit:function(t){t.data.labelsLong.forEach((function(t,e,a){/\n/.test(t)&&(a[e]=t.split(/\n/))}))}}]}),window["Chart"+t]=c}else Draw_Chart_NoData(t,"No data to display")}function Draw_Time_Chart(t){var e=getChartPeriod($("#"+t+"time_Period option:selected").val()),a="DNS Queries",i=timeunitlist[$("#"+t+"time_Period option:selected").val()],o=intervallist[$("#"+t+"time_Period option:selected").val()],n=window[t+e+"time"];if(null==n||0===n.length)return void Draw_Chart_NoData(t+"time","No data to display");var r=[],l=[];for(let t=0;t<n.length;t++)r[n[t].Fieldname]||(l.push(n[t].Fieldname),r[n[t].Fieldname]=1);var s=n.map((function(t){return{x:t.Time,y:t.QueryCount}})),d=window["Chart"+t+"time"];let c=0,u=36e5;"hour"===i?c=u:"day"===i&&(c=864e5),null!=d&&d.destroy();var h=document.getElementById("canvasChart"+t+"time").getContext("2d"),m={segmentShowStroke:!1,segmentStrokeColor:"#000",animationEasing:"easeOutQuart",animationSteps:100,maintainAspectRatio:!1,animateScale:!0,hover:{mode:"point"},legend:{display:!0,position:"top"},title:{display:!0,text:a},tooltips:{callbacks:{title:function(t,e){return moment(t[0].xLabel,"X").format("YYYY-MM-DD HH:mm:ss")},label:function(t,e){return e.datasets[t.datasetIndex].label+": "+e.datasets[t.datasetIndex].data[t.index].y}},mode:"x",position:"cursor",intersect:!1},scales:{xAxes:[{type:"time",gridLines:{display:!0,color:"#282828"},ticks:{min:moment().subtract(o,i+"s"),display:!0},time:{parser:"X",unit:i,stepSize:1}}],yAxes:[{type:getChartScale($("#"+t+"time_Scale option:selected").val(),"time","y"),gridLines:{display:!1,color:"#282828"},scaleLabel:{display:!1,labelString:a},ticks:{display:!0,beginAtZero:!0,labels:{index:["min","max"],removeEmptyLines:!0},userCallback:LogarithmicFormatter}}]},plugins:{zoom:{pan:{enabled:!1,mode:"xy",rangeMin:{x:(new Date).getTime()-c*o,y:getLimit(s,"y","min",!1)},rangeMax:{x:(new Date).getTime(),y:getLimit(s,"y","max",!1)}},zoom:{enabled:!0,drag:!0,mode:"xy",rangeMin:{x:(new Date).getTime()-c*o,y:getLimit(s,"y","min",!1)},rangeMax:{x:(new Date).getTime(),y:getLimit(s,"y","max",!1)},speed:.1}}}},p={datasets:getDataSets(t,n,l)};d=new Chart(h,{type:"line",data:p,options:m}),window["Chart"+t+"time"]=d}function getDataSets(t,e,a){var i=[];colourname="#fc8500";for(var o=0;o<a.length;o++){var n=e.filter((function(t){return t.Fieldname==a[o]})).map((function(t){return{x:t.Time,y:t.QueryCount}}));i.push({label:a[o],data:n,borderWidth:1,pointRadius:1,lineTension:0,fill:!0,backgroundColor:backgroundcolourlist[o],borderColor:bordercolourlist[o]})}return i.reverse(),i}function ChunkString(t,e){for(var a=[],i=t.length,o=0;o<i;o+=e)a.push(t.substr(o,e));return a}function LogarithmicFormatter(t,e,a){if("logarithmic"!==this.type)return isNaN(t)?t:round(t,0).toFixed(0);var i=this.options.ticks.labels||{},o=i.index||["min","max"],n=i.significand||[1,2,5],r=t/Math.pow(10,Math.floor(Chart.helpers.log10(t))),l=!0===i.removeEmptyLines?void 0:"",s="";return 0===e?s="min":e===a.length-1&&(s="max"),"all"===i||-1!==n.indexOf(r)||-1!==o.indexOf(e)||-1!==o.indexOf(s)?0===t?"0":isNaN(t)?t:round(t,0).toFixed(0):l}function GetCookie(t,e){return null!==cookie.get("uidivstats_"+t)?cookie.get("uidivstats_"+t):"string"===e?"":"number"===e?0:void 0}function SetCookie(t,e){cookie.set("uidivstats_"+t,e,3650)}function SetCurrentPage(){document.form.next_page.value=window.location.pathname.substring(1),document.form.current_page.value=window.location.pathname.substring(1)}function initial(){SetCurrentPage(),LoadCustomSettings(),show_menu(),GetConfigFile(),get_domainstoexclude_file(),$("#sortTableContainer").empty(),$("#sortTableContainer").append(BuildQueryLogTableHtmlNoData()),$("#td_charts").append(BuildChartHtml("DNS Queries","TotalBlockedtime","true","false")),$("#td_charts").append(BuildChartHtml("Top blocked domains","Blocked","false","true")),$("#td_charts").append(BuildChartHtml("Top requested domains","Total","false","true")),get_sqldata_file(),get_querylog_file(),get_DivStats_file(),ScriptUpdateLayout(),showhide("databaseSize_text",!0),showhide("tmpfsFreeSpace_text",!0),showhide("backProcStatus_text",!0)}function get_sqldata_file(){$.ajax({url:"/ext/uiDivStats/SQLData.js",dataType:"script",timeout:3e3,error:function(t){setTimeout(get_sqldata_file,1e3)},success:function(){var t;SetuiDivStatsTitle(),showhide("imgUpdateStats",!1),showhide("uidivstats_text",!1),document.getElementById("databaseSize_text").textContent="Database Size: "+sqlDatabaseFileSize,document.getElementById("tmpfsFreeSpace_text").innerHTML="TMPFS Reported: "+tmpfsAvailableSpace+'<span style="padding-left:25px;">RAM Available: '+ramAvailableSpace+"</span>",t="ENABLED"===backgroundProcsState?`${InvGRNct}ENABLED${InvCLEAR}`:`${InvREDct}DISABLED${InvCLEAR}`,document.getElementById("backProcStatus_text").innerHTML="Currently: "+t,$("#uidivstats_div_keystats").append(BuildKeyStatsTableHtml("Key Stats","keystats")),$("#keystats_Period").val(GetCookie("keystats_Period","number")).change(),get_clients_file()}})}function get_clients_file(){$.ajax({url:"/ext/uiDivStats/csv/ipdistinctclients.js",dataType:"script",timeout:3e3,error:function(t){setTimeout(get_clients_file,1e3)},success:function(){for(var t=0;t<metriclist.length;t++){Draw_Chart_NoData(metriclist[t],"Data loading..."),$("#"+metriclist[t]+"_Period").val(GetCookie(metriclist[t]+"_Period","number")),$("#"+metriclist[t]+"_Type").val(GetCookie(metriclist[t]+"_Type","number")),$("#"+metriclist[t]+"_Scale").val(GetCookie(metriclist[t]+"_Scale","number")),ChartScaleOptions($("#"+metriclist[t]+"_Type")[0]);for(var e=0;e<chartlist.length;e++)d3.csv("/ext/uiDivStats/csv/"+metriclist[t]+chartlist[e]+".htm").then(SetGlobalDataset.bind(null,metriclist[t]+chartlist[e])),d3.csv("/ext/uiDivStats/csv/"+metriclist[t]+chartlist[e]+"clients.htm").then(SetGlobalDataset.bind(null,metriclist[t]+chartlist[e]+"clients"))}Draw_Chart_NoData("TotalBlockedtime","Data loading...");for(t=0;t<chartlist.length;t++)$("#TotalBlockedtime_Period").val(GetCookie("TotalBlockedtime_Period","number")),$("#TotalBlockedtime_Scale").val(GetCookie("TotalBlockedtime_Scale","number")),d3.csv("/ext/uiDivStats/csv/TotalBlocked"+chartlist[t]+"time.htm").then(SetGlobalDataset.bind(null,"TotalBlocked"+chartlist[t]+"time"))}})}function GetConfigFile(){$.ajax({url:"/ext/uiDivStats/config.htm",dataType:"text",error:function(t){setTimeout(GetConfigFile,1e3)},success:function(data){let settingname,settingvalue;var configdata=data.split("\n");configdata=configdata.filter(Boolean);for(var indx=0;indx<configdata.length;indx++)0!==configdata[indx].length&&null===configdata[indx].match("^[ ]*#")&&(settingname=configdata[indx].split("=")[0],settingvalue=configdata[indx].split("=")[1].replace(/(\r\n|\n|\r)/gm,""),null!=settingname.match(/^QUERYMODE|^CACHEMODE|^DAYSTOKEEP|^LASTXQUERIES/)&&(eval("document.form.uidivstats_"+settingname.toLowerCase()).value=settingvalue));document.getElementById("theDaysToKeepText").textContent=theDaysToKeepTXT,document.getElementById("theLastXQueriesText").textContent=theLastXQueriesTXT}})}function get_domainstoexclude_file(){$.ajax({url:"/ext/uiDivStats/domainstoexclude.htm",dataType:"text",error:function(t){setTimeout(get_domainstoexclude_file,5e3)},success:function(t){document.getElementById("uidivstats_domainstoexclude").innerHTML=t}})}function get_DivStats_file(){$.ajax({url:"/ext/uiDivStats/DiversionStats.htm",dataType:"text",error:function(t){setTimeout(get_DivStats_file,5e3)},success:function(t){document.getElementById("DiversionStats").innerHTML=t}})}function SetGlobalDataset(t,e){window[t]=e,-1!=t.indexOf("TotalBlocked")?(currentNoChartsTotalBlocked++,currentNoChartsOverall++,currentNoChartsTotalBlocked==maxNoChartsTotalBlocked&&Draw_Time_Chart("TotalBlocked")):-1!=t.indexOf("Blocked")?(currentNoChartsBlocked++,currentNoChartsOverall++,currentNoChartsBlocked==maxNoChartsBlocked&&(SetClients("Blocked"),Draw_Chart("Blocked"))):-1!=t.indexOf("Total")&&(currentNoChartsTotal++,currentNoChartsOverall++,currentNoChartsTotal==maxNoChartsTotal&&(SetClients("Total"),Draw_Chart("Total"))),currentNoChartsOverall==maxNoChartsOverall&&(showhide("imgUpdateStats",!1),showhide("uidivstats_text",!1),showhide("btnUpdateStats",!0),showhide("databaseSize_text",!0),Assign_EventHandlers())}function SetClients(t){var e=window[t+getChartPeriod($("#"+t+"_Period option:selected").val())+"clients"],a=[],i=[];for(let t=0;t<e.length;t++)a[e[t].SrcIP]||(i.push(e[t].SrcIP),a[e[t].SrcIP]=1);i.sort();for(var o=0;o<i.length;o++){var n=hostiparray.filter((function(t){return t[0]==i[o]}))[0];$("#"+t+"_Clients").append($("<option>",{value:o+1,text:n[1]+" ("+n[0]+")"}))}}function ScriptUpdateLayout(){var t=GetVersionNumber("local"),e=GetVersionNumber("server");$("#uidivstats_version_local").text(t),t!=e&&"N/A"!=e&&($("#uidivstats_version_server").text("Updated version available: "+e),showhide("btnChkUpdate",!1),showhide("uidivstats_version_server",!0),showhide("btnDoUpdate",!0))}function update_status(){$.ajax({url:"/ext/uiDivStats/detect_update.js",dataType:"script",timeout:3e3,error:function(t){setTimeout(update_status,1e3)},success:function(){"InProgress"==updatestatus?setTimeout(update_status,1e3):(document.getElementById("imgChkUpdate").style.display="none",showhide("uidivstats_version_server",!0),"None"!=updatestatus?($("#uidivstats_version_server").text("Updated version available: "+updatestatus),showhide("btnChkUpdate",!1),showhide("btnDoUpdate",!0)):($("#uidivstats_version_server").text("No update available"),showhide("btnChkUpdate",!0),showhide("btnDoUpdate",!1)))}})}function CheckAddOnUpdate(){showhide("btnChkUpdate",!1),document.formScriptActions.action_script.value="start_uiDivStatscheckupdate",document.formScriptActions.submit(),document.getElementById("imgChkUpdate").style.display="",setTimeout(update_status,2e3)}function DoAddOnUpdate(){document.form.action_script.value="start_uiDivStatsdoupdate",document.form.action_wait.value=10,showLoading(),document.form.submit(),setTimeout(get_sqldata_file,4e3)}function SaveConfig(){if(!ValidateAll())return!1;document.getElementById("amng_custom").value=JSON.stringify($("form").serializeObject()),document.form.action_script.value="start_uiDivStatsconfig",document.form.action_wait.value=10,showLoading(),document.form.submit()}function RefreshNow(){clearTimeout(tout),showhide("spanRefreshNow",!1),document.formScriptActions.action_script.value="start_uiDivStatsquerylog",document.formScriptActions.submit(),document.getElementById("imgRefreshNow").style.display="",setTimeout(get_querylog_file,5e3)}function GetVersionNumber(t){var e;return"local"===t?e=custom_settings.uidivstats_version_local:"server"===t&&(e=custom_settings.uidivstats_version_server),null==e?"N/A":e}function RedrawAllCharts(){$("#td_charts").append(BuildChartHtml("DNS Queries","TotalBlockedtime","true","false")),$("#td_charts").append(BuildChartHtml("Top blocked domains","Blocked","false","true")),$("#td_charts").append(BuildChartHtml("Top requested domains","Total","false","true")),get_sqldata_file(),Assign_EventHandlers()}function PostStatUpdate(){currentNoChartsBlocked=0,currentNoChartsTotal=0,currentNoChartsTotalBlocked=0,currentNoChartsOverall=0,$("#uidivstats_div_keystats").empty(),$("#uidivstats_chart_TotalBlockedtime").remove(),$("#uidivstats_chart_Blocked").remove(),$("#uidivstats_chart_Total").remove(),setTimeout(RedrawAllCharts,3e3)}function updateStats(){showhide("btnUpdateStats",!1),showhide("databaseSize_text",!1),document.formScriptActions.action_script.value="start_uiDivStats",document.formScriptActions.submit(),showhide("imgUpdateStats",!0),showhide("uidivstats_text",!1),setTimeout(StartUpdateStatsInterval,2e3)}function StartUpdateStatsInterval(){myinterval=setInterval(update_uidivstats,1e3)}void 0!==window.cookie&&"function"==typeof window.cookie.get&&"function"==typeof window.cookie.set||(window.cookie={get:function(t){return window.localStorage.getItem(t)},set:function(t,e,a){window.localStorage.setItem(t,String(e))},unset:function(t){window.localStorage.removeItem(t)}}),$.fn.serializeObject=function(){var t=custom_settings,e=this.serializeArray();$.each(e,(function(){void 0!==t[this.name]&&-1!=this.name.indexOf("uidivstats")&&-1==this.name.indexOf("version")&&-1==this.name.indexOf("domainstoexclude")?(t[this.name].push||(t[this.name]=[t[this.name]]),t[this.name].push(this.value||"")):-1!=this.name.indexOf("uidivstats")&&-1==this.name.indexOf("version")&&-1==this.name.indexOf("domainstoexclude")&&(t[this.name]=this.value||"")}));var a=document.getElementById("uidivstats_domainstoexclude").value.replace(/\n/g,"||||");return t.uidivstats_domainstoexclude=a,t};var statcount=2;function update_uidivstats(){statcount++,$.ajax({url:"/ext/uiDivStats/detect_uidivstats.js",dataType:"script",timeout:1e3,error:function(t){},success:function(){"InProgress"==uidivstatsstatus?(showhide("imgUpdateStats",!0),showhide("uidivstats_text",!0),document.getElementById("uidivstats_text").innerHTML="Stat update in progress - "+statcount+"s elapsed"):"Done"==uidivstatsstatus?(document.getElementById("uidivstats_text").innerHTML="Refreshing charts...",statcount=2,clearInterval(myinterval),PostStatUpdate()):"LOCKED"==uidivstatsstatus&&(showhide("imgUpdateStats",!1),document.getElementById("uidivstats_text").innerHTML="Stat update already running!",showhide("uidivstats_text",!0),showhide("btnUpdateStats",!0),clearInterval(myinterval))}})}function reload(){location.reload(!0)}function ToggleFill(){"false"===ShowFill?(ShowFill="origin",SetCookie("ShowFill","origin")):(ShowFill="false",SetCookie("ShowFill","false"));for(var t=0;t<metriclist.length;t++)for(var e=0;e<chartlist.length;e++)window["Chart"+metriclist[t]+chartlist[e]+"time"].data.datasets[0].fill=ShowFill,window["Chart"+metriclist[t]+chartlist[e]+"time"].update()}function getLimit(t,e,a,i){var o,n=0;return o="x"===e?t.map((function(t){return t.x})):t.map((function(t){return t.y})),n="max"===a?Math.max.apply(Math,o):Math.min.apply(Math,o),"max"===a&&0===n&&!1===i&&(n=1),n}function getAverage(t){for(var e=0,a=0;a<t.length;a++)e+=1*t[a].y;return e/t.length}function getMax(t){return Math.max(...t)}function round(t,e){return Number(Math.round(t+"e"+e)+"e-"+e)}function getRandomColor(){return"rgba("+Math.floor(255*Math.random())+","+Math.floor(255*Math.random())+","+Math.floor(255*Math.random())+",1)"}function poolColors(t){for(var e=[],a=0;a<t;a++)e.push(getRandomColor());return e}function getChartType(t){var e="horizontalBar";return 0==t?e="horizontalBar":1==t?e="bar":2==t&&(e="pie"),e}function getChartPeriod(t){var e="daily";return 0==t?e="daily":1==t?e="weekly":2==t&&(e="monthly"),e}function getChartScale(t,e,a){var i="category";return 0==t?("horizontalBar"===e&&"x"===a||"bar"===e&&"y"===a||"time"===e&&"y"===a)&&(i="linear"):1==t&&("horizontalBar"===e&&"x"===a||"bar"===e&&"y"===a||"time"===e&&"y"===a)&&(i="logarithmic"),i}function ChartScaleOptions(t){var e=t.id.substring(0,t.id.indexOf("_"));let a=$("#"+e+"_Scale");2!=$("#"+e+"_Type option:selected").val()?1==a[0].length&&(a.empty(),a.append($("<option></option>").attr("value",0).text("Linear")),a.append($("<option></option>").attr("value",1).text("Logarithmic")),a.prop("selectedIndex",0)):2==a[0].length&&(a.empty(),a.append($("<option></option>").attr("value",0).text("Linear")),a.prop("selectedIndex",0))}function ZoomPanEnabled(t){return"bar"===t?"y":"horizontalBar"===t?"x":""}function ZoomPanMax(t,e,a){return"x"===e?"bar"===t?null:"horizontalBar"===t?getMax(a):null:"y"===e?"bar"===t?getMax(a):null:void 0}function ResetZoom(){for(var t=0;t<metriclist.length;t++){null!=(e=window["Chart"+metriclist[t]])&&e.resetZoom()}var e;null!=(e=window.ChartTotalBlockedtime)&&e.resetZoom()}function DragZoom(t){var e=!0,a=!1,i="";-1!==t.value.indexOf("On")?(e=!1,a=!0,i="Drag Zoom Off"):(e=!0,a=!1,i="Drag Zoom On");for(var o=0;o<metriclist.length;o++)for(var n=0;n<chartlist.length;n++){var r=window["Chart"+metriclist[o]+chartlist[n]];null!=r&&(r.options.plugins.zoom.zoom.drag=e,r.options.plugins.zoom.pan.enabled=a,t.value=i,r.update())}}function showGrid(t,e){return null===t||"pie"!==t}function showAxis(t,e){return"bar"===t&&"x"===e||(null===t||"pie"!==t)}function showTicks(t,e){return("bar"!==t||"x"!==e)&&(null===t||"pie"!==t)}function showLegend(t){return"pie"===t}function showTitle(t){return"pie"===t}function getChartPadding(t){return"bar"===t?10:0}function getChartLegendTitle(){for(var t="Domain name",e=0;e<350-t.length;e++)t+=" ";return t}function getAxisLabel(t,e){var a="";return"x"===e?("horizontalBar"===t?a="Hits":("bar"===t||"pie"===t)&&(a=""),a):"y"===e?("horizontalBar"===t?a="":"bar"==t?a="Hits":"pie"==t&&(a=""),a):void 0}function changeChart(t){value=1*t.value,name=t.id.substring(0,t.id.indexOf("_")),-1===t.id.indexOf("Clients")&&SetCookie(t.id,value),-1!==t.id.indexOf("Period")&&-1===t.id.indexOf("TotalBlocked")&&($("#"+name+"_Clients option[value!=0]").remove(),SetClients(name)),-1===t.id.indexOf("time")?Draw_Chart(name):Draw_Time_Chart(name.replace("time",""))}function changeTable(t){value=1*t.value,name=t.id.substring(0,t.id.indexOf("_")),SetCookie(t.id,value);var e=getChartPeriod(value);$("#keystatstotal").text(window["QueriesTotal"+e]),$("#keystatsblocked").text(window["QueriesBlocked"+e]),$("#keystatspercent").text(window["BlockedPercentage"+e])}function BuildChartHtml(t,e,a,i){var o='<div style="line-height:10px;">&nbsp;</div>';return o+='<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="uidivstats_chart_'+e+'">',o+='<thead class="collapsible-jquery"',o+='<tr><td colspan="2">'+t+" (click to expand/collapse)</td></tr>",o+="</thead>",o+='<tr class="even">',o+='<th width="40%">Period to display</th>',o+="<td>",o+='<select style="width:150px" class="input_option" onchange="changeChart(this)" id="'+e+'_Period">',o+="<option value=0>Last 24 hours</option>",o+="<option value=1>Last 7 days</option>",o+="<option value=2>Last 30 days</option>",o+="</select>",o+="</td>",o+="</tr>","false"===a&&(o+='<tr class="even">',o+='<th width="40%">Layout for chart</th>',o+="<td>",o+='<select style="width:100px" class="input_option" onchange="ChartScaleOptions(this);changeChart(this)" id="'+e+'_Type">',o+="<option value=0>Horizontal</option>",o+="<option value=1>Vertical</option>",o+="<option value=2>Pie</option>",o+="</select>",o+="</td>",o+="</tr>"),o+='<tr class="even">',o+='<th width="40%">Scale type</th>',o+="<td>",o+='<select style="width:150px" class="input_option" onchange="changeChart(this)" id="'+e+'_Scale">',o+="<option value=0>Linear</option>",o+="<option value=1>Logarithmic</option>",o+="</select>",o+="</td>",o+="</tr>","true"===i&&(o+='<tr class="even">',o+='<th width="40%">Client to display</th>',o+="<td>",o+='<select style="width:250px" class="input_option" onchange="changeChart(this)" id="'+e+'_Clients">',o+="<option value=0>All (*)</option>",o+="</select>",o+="</td>",o+="</tr>"),o+="<tr>",o+='<td colspan="2" style="padding: 2px;">',o+='<div style="background-color:#2f3e44;border-radius:10px;width:735px;padding-left:5px;" id="divChart'+e+'"><canvas id="canvasChart'+e+'" height="500"></div>',o+="</td>",o+="</tr>",o+="</table>"}function BuildKeyStatsTableHtml(t,e){var a='<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="uidivstats_table_keystats">';return a+='<col style="width:40%;">',a+='<col style="width:60%;">',a+='<thead class="collapsible-jquery">',a+='<tr><td colspan="2">'+t+" (click to expand/collapse)</td></tr>",a+="</thead>",a+='<tr class="even">',a+="<th>Domains currently on blocklist</th>",a+='<td id="keystatsdomains" style="font-size: 16px; font-weight: bolder;">'+BlockedDomains+"</td>",a+="</tr>",a+='<tr class="even">',a+="<th>Period to display</th>",a+='<td colspan="2">',a+='<select style="width:150px" class="input_option" onchange="changeTable(this)" id="'+e+'_Period">',a+="<option value=0>Last 24 hours</option>",a+="<option value=1>Last 7 days</option>",a+="<option value=2>Last 30 days</option>",a+="</select>",a+="</td>",a+="</tr>",a+='<tr style="line-height:5px;">',a+='<td colspan="2">&nbsp;</td>',a+="</tr>",a+="<tr>",a+='<td colspan="2" align="center" style="padding: 0px;">',a+='<table border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable StatsTable">',a+='<col style="width:250px;">',a+='<col style="width:250px;">',a+='<col style="width:250px;">',a+="<thead>",a+="<tr>",a+="<th>Total Queries</th>",a+="<th>Queries Blocked</th>",a+="<th>Percent Blocked</th>",a+="</tr>",a+="</thead>",a+='<tr class="even" style="text-align:center;">',a+='<td id="keystatstotal"></td>',a+='<td id="keystatsblocked"></td>',a+='<td id="keystatspercent"></td>',a+="</tr>",a+="</table>",a+="</td>",a+="</tr>",a+='<tr style="line-height:5px;">',a+='<td colspan="2">&nbsp;</td>',a+="</tr>",a+="</table>"}function BuildQueryLogTableHtmlNoData(){return"<tr>",'<td colspan="3" class="nodata">',"Data loading...","</td>","</tr>","</table>",'<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="sortTable"><tr><td colspan="3" class="nodata">Data loading...</td></tr></table>'}function BuildQueryLogTableHtml(){var t='<table border="0" cellpadding="0" cellspacing="0" width="100%" class="sortTable" style="table-layout:fixed;" id="sortTable">';t+='<col style="width:110px;">',t+='<col style="width:320px;">',t+='<col style="width:110px;">',t+='<col style="width:50px;">',t+='<col style="width:140px;">',t+='<thead class="sortTableHeader">',t+="<tr>",t+='<th class="sortable" onclick="SortTable(this.innerHTML)">Time</th>',t+='<th class="sortable" onclick="SortTable(this.innerHTML)">Domain</th>',t+='<th class="sortable" onclick="SortTable(this.innerHTML)">Client</th>',t+='<th class="sortable" onclick="SortTable(this.innerHTML)">Type</th>',t+='<th class="sortable" onclick="SortTable(this.innerHTML)">Result</th>',t+="</tr>",t+="</thead>",t+='<tbody class="sortTableContent">';for(var e=0;e<arrayqueryloglines.length;e++)t+='<tr class="sortRow">',t+="<td>"+arrayqueryloglines[e].Time+"</td>",t+="<td>"+arrayqueryloglines[e].ReqDmn+"</td>",t+="<td>"+arrayqueryloglines[e].SrcIP+"</td>",t+="<td>"+arrayqueryloglines[e].QryType+"</td>",t+="<td>"+arrayqueryloglines[e].Result+"</td>",t+="</tr>";return t+="</tbody>",t+="</table>"}function get_querylog_file(){$.ajax({url:"/ext/uiDivStats/csv/SQLQueryLog.htm",dataType:"text",error:function(t){tout=setTimeout(get_querylog_file,1e3)},success:function(t){ParseQueryLog(t),document.getElementById("imgRefreshNow").style.display="none",showhide("spanRefreshNow",!0),document.getElementById("auto_refresh").checked&&(tout=setTimeout(get_querylog_file,6e4))}})}function ParseQueryLog(t){var e=t.split("\n");e=e.filter(Boolean),arrayqueryloglines=[];for(var a=0;a<e.length;a++){var i=e[a].split("|"),o=new Object;o.Time=moment.unix(i[0]).format("YYYY-MM-DD HH:mm").trim(),o.ReqDmn=i[1].trim(),o.SrcIP=i[2].trim(),o.QryType=i[3].trim(),o.Result="1"==i[4].trim()?"Allowed":"Blocked",arrayqueryloglines.push(o)}originalarrayqueryloglines=arrayqueryloglines,FilterQueryLog()}function FilterQueryLog(){""==$("#filter_reqdmn").val()&&""==$("#filter_srcip").val()&&0==$("#filter_qrytype option:selected").val()&&0==$("#filter_result option:selected").val()?arrayqueryloglines=originalarrayqueryloglines:(arrayqueryloglines=originalarrayqueryloglines,""!=$("#filter_reqdmn").val()&&(arrayqueryloglines=$("#filter_reqdmn").val().startsWith("!")?arrayqueryloglines.filter((function(t){return-1==t.ReqDmn.toLowerCase().indexOf($("#filter_reqdmn").val().replace("!","").toLowerCase())})):arrayqueryloglines.filter((function(t){return-1!=t.ReqDmn.toLowerCase().indexOf($("#filter_reqdmn").val().toLowerCase())}))),""!=$("#filter_srcip").val()&&(arrayqueryloglines=$("#filter_srcip").val().startsWith("!")?arrayqueryloglines.filter((function(t){return-1==t.SrcIP.indexOf($("#filter_srcip").val().replace("!",""))})):arrayqueryloglines.filter((function(t){return-1!=t.SrcIP.indexOf($("#filter_srcip").val())}))),0!=$("#filter_qrytype option:selected").val()&&(arrayqueryloglines=arrayqueryloglines.filter((function(t){return t.QryType==$("#filter_qrytype option:selected").text()}))),0!=$("#filter_result option:selected").val()&&(arrayqueryloglines=arrayqueryloglines.filter((function(t){return t.Result==$("#filter_result option:selected").text()})))),SortTable(sortname+" "+sortdir.replace("desc","↑").replace("asc","↓").trim())}function SortTable(sorttext){sortname=sorttext.replace("↑","").replace("↓","").trim();var sortfield=sortname;switch(sortname){case"Time":sortfield="Time";break;case"Domain":sortfield="ReqDmn";break;case"Client":sortfield="SrcIP";break;case"Type":sortfield="QryType";break;case"Result":sortfield="Result";break}-1==sorttext.indexOf("↓")&&-1==sorttext.indexOf("↑")||-1!=sorttext.indexOf("↓")?(eval("arrayqueryloglines = arrayqueryloglines.sort((a,b) => (a."+sortfield+" > b."+sortfield+") ? 1 : ((b."+sortfield+" > a."+sortfield+") ? -1 : 0)); "),sortdir="asc"):(eval("arrayqueryloglines = arrayqueryloglines.sort((a,b) => (a."+sortfield+" < b."+sortfield+") ? 1 : ((b."+sortfield+" < a."+sortfield+") ? -1 : 0)); "),sortdir="desc"),$("#sortTableContainer").empty(),$("#sortTableContainer").append(BuildQueryLogTableHtml()),$(".sortable").each((function(t,e){e.innerHTML==sortname&&(e.innerHTML="asc"==sortdir?sortname+" ↑":sortname+" ↓")}))}function Assign_EventHandlers(){$(".collapsible-jquery").off("click").on("click",(function(){$(this).siblings().toggle("fast",(function(){"none"==$(this).css("display")?SetCookie($(this).siblings()[0].id,"collapsed"):SetCookie($(this).siblings()[0].id,"expanded")}))})),$(".collapsible-jquery").each((function(t,e){"collapsed"==GetCookie($(this)[0].id,"string")?$(this).siblings().toggle(!1):$(this).siblings().toggle(!0)}));let t=null,e=null;$("#filter_reqdmn").off("keyup touchend").on("keyup touchend",(function(e){clearTimeout(t),t=setTimeout((function(){FilterQueryLog()}),1e3)})),$("#filter_srcip").off("keyup touchend").on("keyup touchend",(function(t){clearTimeout(e),e=setTimeout((function(){FilterQueryLog()}),1e3)})),$("#auto_refresh").off("click").on("click",(function(){ToggleRefresh()}))}function ToggleRefresh(){$("#auto_refresh").prop("checked",(function(t,e){e?get_querylog_file():clearTimeout(tout)}))}
...
&nbsp;&nbsp;&nbsp;
<input type="button" class="button_gen" onclick="CheckAddOnUpdate();" value="Check" id="btnChkUpdate">
<img id="imgChkUpdate" style="display:none;vertical-align:middle;" src="images/InternetScan.gif"/>
<input type="button" class="button_gen" onclick="DoAddOnUpdate();" value="Update" id="btnDoUpdate" style="display:none;">
&nbsp;&nbsp;&nbsp;
</td>
</tr>
</table>
...
-->
&nbsp;&nbsp;&nbsp;
<span id="databaseSize_text" style="display:none; font-size: 14px; font-weight: bolder;"></span>
</td>
</tr>
</table>
<div style="line-height:10px;">&nbsp;</div>
...
**-------------------------------------**
-->
<br><span id="tmpfsFreeSpace_text" style="margin-left:4px; display:none; font-size: 12px; font-weight: bold;"></span></br>
</td>
</tr>
...
<input autocomplete="off" type="text" maxlength="5"
   class="input_6_table removespacing" name="uidivstats_lastxqueries" value="5000"
   onkeypress="return validator.isNumber(this,event)"
   onblur="ValidateNumberSetting(this,theLastXQueriesMAX,theLastXQueriesMIN);FormatNumberSetting(this)"
   onkeyup="ValidateNumberSetting(this,theLastXQueriesMAX,theLastXQueriesMIN)" data-lpignore="true"/>
&nbsp;results <span id="theLastXQueriesText" style="margin-left:4px; color:#FFCC00;"></span>
</td>
</tr>
...
<input autocomplete="off" type="text" maxlength="3"
   class="input_6_table removespacing" name="uidivstats_daystokeep" value="30"
   onkeypress="return validator.isNumber(this,event)"
...
**-------------------------------------**
-->
<tr class="even" id="backProcStatus">
<td class="settingname">Background processing status</td>
<td class="settingvalue">
<span id="backProcStatus_text" style="margin-left:4px; display:none; font-size: 12px; font-weight: bolder;"></span>
</td>
</tr>
...
<textarea cols="75" rows="35" wrap="off" readonly="readonly" id="DiversionStats" class="textarea_log_table" style="font-family:'Courier New',Courier,mono;font-size:11px;border:none;padding:0px;">If you are seeing this message, it means you don't have a weekly stats file from Diversion present
on your router.
Please check that weekly stats are enabled in Diversion SSH UI, menu option c 1.</textarea>
</td>
</tr>
</table>
</td>
